...
const comoTrabalhamosData = [
  {
    ...
    descricao:
      "Grãos artesanais e um menu de lanches feitos na hora, para o seu máximo conforto.",
  },
  {
    icone: "🐾",
    titulo: "Nossos Residentes",
    descricao:
      "Gatos resgatados e socializados em um ambiente seguro, prontos para receber seu carinho.",
  },
  {
    icone: "❤️",
    titulo: "Regras Simples",
    descricao:
      "Priorizamos o bem-estar felino. Mantenha a voz baixa e deixe os gatos dormirem em paz.",
  },
  {
    icone: "🏠",
    titulo: "Adote um Amigo",
    descricao:
      "Sua visita apoia a causa! Conheça os gatos disponíveis para adoção e mude uma vida.",
  },
];
